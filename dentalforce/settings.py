"""
    Django settings for dentalforce project.
...
MIDDLEWARE = [
    ...
    'dentalforce.middleware.ClinicaMiddleware',  # Multi-tenant segregation
    'dentalforce.middleware_contrasena.ForzarCambioContrasenaTemporalMiddleware',  # Forzar cambio de contraseña temporal
]

ROOT_URLCONF = 'dentalforce.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'dentalforce.context_processors.clinica_context',
                'dentalforce.context_processors.menu_urls',
            ],
            'libraries': {
...
WSGI_APPLICATION = 'dentalforce.wsgi.application'
